...
eval_metrics = [
    # from baseline paper: git/rpg_e2depth/evaluation.py
    "abs_difference_10m",
    "abs_difference_20m",
    "abs_difference_30m",
    # original metrics    
...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--alignment",
        choices=[None, "least_square", "least_square_disparity", "absolute"],
        default=None,
    ...
    for data in tqdm(dataloader, desc="Evaluating"):
        ...
        if "absolute" == alignment:
            depth_pred_denorm = depth_pred * max_depth
        elif "inverse_log" == alignment:
            maxd = max_depth
