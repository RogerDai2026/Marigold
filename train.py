...
if "__main__" == __name__:
    ...
    if resume_run is not None:
        ...
        # Full job name
        pure_job_name = os.path.basename(args.config).split(".")[0] + f"_{args.ckpt_tag}"
        # Add time prefix
    ...
    for _val_dic in cfg_data.val:
        _val_dataset: BaseDepthDataset = get_dataset(
            _val_dic,
            base_data_dir=base_data_dir,
    ...
    for _vis_dic in cfg_data.vis:
        _vis_dataset: BaseDepthDataset = get_dataset(
            _vis_dic,
            base_data_dir=base_data_dir,
            mode=DatasetMode.EVAL,
            depth_transform=depth_transform,
